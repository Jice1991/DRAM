...
%% plot
figure(1)
plot(chain(1:end,2),'m-','LineWidth',1); 
    hold on
plot(chain(1:end,6),'g-','LineWidth',1); 
    hold on
plot(chain(1:end,13),'y-','LineWidth',1); 
    hold on
plot(chain(1:end,19),'k-','LineWidth',1); 
hold on
plot(chain(1:end,24),'c-','LineWidth',1); 
    hold on
plot(chain(1:end,28),'b-','LineWidth',1); 
    hold on
...
set(gca,'fontsize',20);
set(gca,'ylim',[0.85 1.2],'ytick',[0.85:0.1:1.2])
...
for i=1:30
    ...
    hold on
    elseif i==24
            plot(chain(1:end,i),'c-','LineWidth',1); 
    hold on
    elseif i==28
            plot(chain(1:end,i),'r-','LineWidth',1); 
    hold on
    else 
